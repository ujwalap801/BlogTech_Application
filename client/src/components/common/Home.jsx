  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (selectedRole === "author") {
        res = await axios.post('https://blogtech-application.onrender.com/author-api/author', updatedUser);
      } else {
        res = await axios.post('https://blogtech-application.onrender.com/user-api/user', updatedUser);
      }
